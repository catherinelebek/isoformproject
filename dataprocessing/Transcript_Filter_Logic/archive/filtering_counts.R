...
datfull.counts <- read.delim("/Users/catherinehogg/Documents/Semester3/Project/InputData/isoforms/firstdata/PvR_isoformCounts_all.txt", 
                             header = TRUE, sep = "\t")
...
keep <- y$samples$Patient.ID %in% patientskeep # indexes for patient samples in the patientskeep file
...
write.table(omit, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/firstdata/transcriptsomit.csv", row.names = F)
