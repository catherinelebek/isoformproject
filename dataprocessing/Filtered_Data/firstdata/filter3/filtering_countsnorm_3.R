...
ynorm <- cbind(y$genes, ynorm)

# write to file

write.table(y, "/Users/catherinehogg/Documents/Semester3/Project/Results/localresults/filter3/PvR_isoformnormCounts_filtered.txt")
