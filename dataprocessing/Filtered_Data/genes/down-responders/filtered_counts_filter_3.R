...
lowexp <- read.csv("/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/genes/down-responders/transcriptsomit.csv", header = TRUE, sep = ",")
...
write.table(dat, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/genes/down-responders/PvR_geneCounts_filtered.txt",
            sep = "\t")
