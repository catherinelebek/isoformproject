...
# pull down-responders from patients keep - 14 patients
...
stead.up <- stead.up$Row.names

stead.up <- sub("\\..*","",stead.up)

# filter out the transcripts with low expression values

keep <- glassdat[,1] %in% stead.up
glassdat <- glassdat[keep,] # this is the final set of data


write.table(glassdat, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/glass/up-responders/PvR_isoformCounts_filtered.txt",
            sep = "\t")
