...
patientskeep <- read.delim("/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/down-responders/patientskeep.txt", header = FALSE)
...
lowexp <- read.csv("/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/down-responders/transcriptsomit.csv", header = TRUE, sep = ",")
...
write.table(dat, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/down-responders/PvR_isoformCounts_filtered.txt",
            sep = "\t")
