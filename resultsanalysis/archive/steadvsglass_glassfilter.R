...
glass.up <- read.delim("~/Documents/Semester3/Project/Results/dea/isoforms/glass/up-responders/glassfilter/deseq2results.csv", header = T, sep = ",")
glass.down <- read.delim("~/Documents/Semester3/Project/Results/dea/isoforms/glass/down-responders/glassfilter/deseq2results.csv", header = T, sep = ",")
...
test <-  up.compare[up.compare$stead.sig == T & !is.na(up.compare$stead.sig) & up.compare$glass.sig == F & !is.na(up.compare$GLASS.LFC),]
...
test <-  down.compare[down.compare$stead.sig == T & !is.na(down.compare$stead.sig) & down.compare$glass.sig == F & !is.na(down.compare$GLASS.LFC),]
