# This script runs gene-level DEA using DESeq2 on the paired samples from 44 patients (in-house dataset)

library(DESeq2)
library(BiocParallel)

counts <- read.delim("~/Documents/Semester3/Project/Results/filtered_data/genes/up-responders/PvR_geneCounts_filtered.txt",header = T, sep = "\t")
...
save(dds, file = "~/Documents/Semester3/Project/Results/dea/genes/up-responders/deseq2.RData")
