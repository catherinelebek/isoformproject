# This script runs isoform-level DEA using DESeq2 on the paired samples from 9 down-responder patients (glass dataset)


library(DESeq2)
library(BiocParallel)

counts <- read.delim("~/Documents/Semester3/Project/Results/filtered_data/isoforms/glass/down-responders/glassfilter/PvR_isoformCounts_filtered.txt",header = T, sep = "\t")
...
save(dds, file = "~/Documents/Semester3/Project/Results/dea/isoforms/glass/down-responders/glassfilter/deseq2.RData")
