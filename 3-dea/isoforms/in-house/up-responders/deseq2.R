# This script runs isoform-level DEA using DESeq2 on the paired samples from 44 up-responder patients (in-house dataset)

library(DESeq2)
# library(BiocParallel)

# counts <- read.delim("~/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/up-responders/PvR_isoformCounts_filtered.txt",header = T, sep = "\t")
...
save(dds, file = "/nobackup/bs20chlb/outputdata/dea/seconddata/up-responders/deseq2.RData")
