...
load("~/Documents/Semester3/Project/Results/dea/isoforms/glass/up-responders/deseq2.RData")
...
write.csv(resOrdered, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/isoforms/glass/up-responders/deseq2results.csv")
