...
load("~/Documents/Semester3/Project/Results/dea/isoforms/filter3/firstdata/deseq2.RData")

# load full list of transcripts in order to pull through gene names

genelist <- read.delim("/Users/catherinehogg/Documents/Semester3/Project/InputData/isoforms/firstdata/PvR_isoformCounts_all.txt",
                       header = T, sep = "\t")
...
write.csv(merge, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/isoforms/filter3/firstdata/deseq2results.csv")
