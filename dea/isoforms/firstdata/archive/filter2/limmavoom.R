...
dat <- read.table("/Users/catherinehogg/Documents/Semester3/Project/Results/localresults/stringent/PvR_isoformCounts_filtered.txt", header = TRUE)
...
write.table(restop, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/stringent/limmaresults.csv")
