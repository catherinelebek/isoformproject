...
load("~/Documents/Semester3/Project/Results/dea/filter0/deseq.RData")
...
write.csv(merge, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/filter0/deseq2results.csv")
