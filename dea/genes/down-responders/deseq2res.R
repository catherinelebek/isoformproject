...
load("~/Documents/Semester3/Project/Results/dea/genes/down-responders/deseq2.RData")
...
write.csv(merge, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/genes/down-responders/deseq2results.csv")
...
ggplot(merge) +
  ...
  ggtitle("Differential Gene Expression - Down-Responders") +
