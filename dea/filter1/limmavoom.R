...
dat <- read.table("/Users/catherinehogg/Documents/Semester3/Project/Results/localresults/nonstringent/PvR_isoformCounts_filtered.txt", header = TRUE)
...
write.table(restop, "/Users/catherinehogg/Documents/Semester3/Project/Results/dea/nonstringent/limmaresults.csv")
