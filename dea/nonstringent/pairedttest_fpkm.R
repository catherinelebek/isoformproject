...
dat.allcol <- read.table("/nobackup/bs20chlb/inputdata/stringent/PvR_isoformfpkm_filtered.txt", header = TRUE)
...
write.table(ttest, "/nobackup/bs20chlb/outputdata/dea/stringent/pairedttestresults_fpkm.csv")
