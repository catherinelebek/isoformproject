# This script filters the full list of samples from the in-house data based on metadata and sequencing values to output a list of 88 samples from 44 up-responder patients
...
write.table(patientskeep, 
            "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/up-responders/patientskeep.txt",
