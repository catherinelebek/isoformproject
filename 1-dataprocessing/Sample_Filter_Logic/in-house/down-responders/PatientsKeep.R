# This script filters the full list of samples from the in-house data based on metadata and sequencing values to output a list of 44 samples from 22 down-responder patients
...
keep <- metadata.mod$Initial.Diagnosis == "Primary GBM" & metadata.mod$Location.Primary == metadata.mod$Location.Recurrence &
        ...
        metadata.mod$IDH == 0 & metadata.mod$NES < 0
...
write.table(patientskeep, 
            "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/seconddata/down-responders/patientskeep.txt",
