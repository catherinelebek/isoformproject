# This script gives a list of genes to keep based on count data from filtered down-responder patients (44 samples across 22 patients)
...
write.table(omit, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/genes/down-responders/transcriptsomit.csv", row.names = F)
