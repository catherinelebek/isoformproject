# This script gives a list of transcripts to keep based on count data from patients included in the full filtered dataset (132 samples across 66 patients)
