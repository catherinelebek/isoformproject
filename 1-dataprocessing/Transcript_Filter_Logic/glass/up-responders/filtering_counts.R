# This script gives a list of transcripts to keep based on count data from filtered up-responder glass patients (28 samples across 14 patients)
...
write.table(omit, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/glass/up-responders/glassfilter/transcriptsomit.csv", row.names = F)
