# This script gives a list of transcripts to keep based on count data from patients included in the full filtered glass dataset (46 samples across 23 patients)
