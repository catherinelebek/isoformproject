# This script gives a list of transcripts to keep based on count data from filtered down-responder glass patients (18 samples across 9 patients)
...
write.table(omit, "/Users/catherinehogg/Documents/Semester3/Project/Results/filtered_data/isoforms/glass/down-responders/glassfilter/transcriptsomit.csv", row.names = F)
